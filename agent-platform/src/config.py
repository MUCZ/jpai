...
TASK_RESULT_SINK_MAX_ENTRIES = int(os.getenv("TASK_RESULT_SINK_MAX_ENTRIES", "1000"))
EXECUTION_AUDIT_SINK_MAX_ENTRIES = int(os.getenv("EXECUTION_AUDIT_SINK_MAX_ENTRIES", "500"))
